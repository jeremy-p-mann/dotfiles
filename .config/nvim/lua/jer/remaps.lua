...
-- Testing
nremap('<leader>tn', [[<CMD>TestNearest<CR><CMD>]])
nremap('<leader>tf', [[<CMD>TestFile<CR><CMD>]])
nremap('<leader>ts', [[<CMD>TestSuite<CR><CMD>]])
nremap('<leader>tl', [[<CMD>TestLast<CR><CMD>]])
nremap('<leader>tv', [[<CMD>TestVisit<CR><CMD>]])
-- LSP
